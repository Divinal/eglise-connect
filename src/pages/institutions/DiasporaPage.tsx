...
const DiasporaPage = () => {
  ...
  const [items, setItems] = useState<DiasporaComm[]>([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    (supabase as any).from("diaspora")
    ...
    <Layout>
      <div className="bg-primary py-12">
        <div className="container">
          <h1 className="font-display text-3xl md:text-4xl text-primary-foreground">Diaspora</h1>
          <p className="text-primary-foreground/70 mt-2">Communautés EEC à l'international</p>
        </div>
      </div>
        ...
        <div className="container">
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground">Aucune communauté diaspora pour l'instant.</p>
            </div>
          ) : (
