    ...
    <Layout>
      <div className="bg-primary py-12">
        <div className="container">
          <h1 className="font-display text-3xl md:text-4xl text-primary-foreground">UPB</h1>
          <p className="text-primary-foreground/70 mt-2">
            Union Presbytérale de Base de l'Église Évangélique du Congo
          </p>
        </div>
      </div>
              ...
              <aside className="w-full lg:w-72 shrink-0">
                <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
                  <div className="bg-[#1a3a5c] px-4 py-3">
                    <h3 className="font-semibold text-white text-sm">Bureau UPB</h3>
                  </div>
